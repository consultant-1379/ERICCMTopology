...
function setRstate {
	...
	#mv ERICCMTopology/build/feature-release.xml ERICCMTopology/build/feature-release.${rstate}.xml
...
function nexusDeploy {
	...
	ArtifactId=$module
	zipName=ERICCMTopology
	
	echo "****"	
	echo "Deploying the zip /$zipName as ${ArtifactId}${rstate}.zip to Nexus...."
